...
if species_type == 'Setosa':
    ...
    st.image(load_image('C:\\Users\\MILIND\\Documents\\Python projects\\iris_setosa.jpg'))
elif species_type == 'Versicolor':
    st.text("Showing Versicolor Species")
    st.image(load_image('C:\\Users\\MILIND\\Documents\\Python projects\\IRIS_VERSICOLOR.jpg'))
elif species_type == 'Virginica':
    st.text("Showing Virginica Species")
    st.image(load_image('C:\\Users\\MILIND\\Documents\\Python projects\\virginca.jpg'))
